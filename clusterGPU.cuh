...
void allocateCalibDataGPU(calib_data_t **pt_calib_data_t, gpu_timing_t *gpu_timing, int dev, cudaStream_t stream);
...
void freeCalibDataGPU(calib_data_t *pt_calib_data_t, gpu_timing_t *gpu_timing, int dev, cudaStream_t stream);
